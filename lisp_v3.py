...
class lisp_map_register(object):
    def __init__(self):
        ...
        self.computing_resource = 0 #[added code]
    #enddef
    ...
    def decode(self, packet):
        ...
        self.computing_resource = first_long & 0xff #[added code]
...
class lisp_eid_record(object):
    def __init__(self):
        ...
        self.record_ttl = 0
        self.computing_resource = "" #[added code]
    #enddef
    ...
    def print_record(self, indent, ddt):
        ...
        line = ("{}EID-record -> record-ttl: {}, computing-resource: {}, action: " +
            "{}, {}{}{}, map-version: {}, afi: {}, [iid]eid/ml: {}")                    #[added code]

        lprint(line.format(indent, self.print_ttl(), self.computing_resource, 
    ...
    def encode(self):
        ...
        packet = struct.pack("I500sBHHH", socket.htonl(self.record_ttl), 
            self.computing_resource, mask_len, socket.htons(action),
            socket.htons(sig_mv), socket.htons(afi)) # [added code]
    ...
    def decode(self, packet):
        ...
        #     struct.unpack(packet_format, packet[:format_size])
        self.record_ttl, self.computing_resource, self.eid.mask_len, action, \
            self.map_version, self.eid.afi = \
            struct.unpack(packet_format, packet[:format_size]) # [added code]
